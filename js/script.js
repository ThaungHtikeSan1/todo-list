...
const countTotalLists=()=>{
    const Lists = document.querySelectorAll(".list")
    totalList.innerText = Lists.length
}

const countTotalDoneLists=()=>{
...
const createList=(text)=>{
    ...
    list.innerHTML=`<div class="flex justify-between items-center border p-2 mb-4">
                <div class="flex items-center gap-2">
                    <input type="checkbox" class="doneCheck accent-gray-900">
